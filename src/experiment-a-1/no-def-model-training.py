...
python wt-def-model-training.py /path/to/save/model/model-name.h5 /path/to/dataset
...
x_train, y_train, x_valid, y_valid, x_test, y_test, nb_classes = load_data_no_def(DATA_PATH, p["features"])
