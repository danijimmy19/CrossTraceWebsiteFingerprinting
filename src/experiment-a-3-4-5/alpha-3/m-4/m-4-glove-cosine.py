...
CNN_PATH = sys.argv[1]
# path of the dataset
# data_dir = '/home/danijy/projects/webfp-crossed-fingerprints-data/closed-world/wt-def-keyword/wt-analysis-three-traces-250/paired-data/wt-def-keyword-2-paired.csv'
data_dir = sys.argv[2]
# path of NLP model
...
#     for i in range(0, 18, 3):
        ...
        temp_acc_1, temp_acc_2, temp_acc_3, temp_acc_4 = get_accuracy(pairs_c, pairs_c_dist, t1_actual_label, t2_actual_label, t3_actual_label)
