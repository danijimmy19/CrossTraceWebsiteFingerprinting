...
# for evaluating Cosine Similarity
...
# path to CNN model
# CNN_PATH = '../webfp-crossed-fingerprints/closed-world/models/wt-def/wt-def-keyword-100-classes-2000-250-direction-model.h5'
CNN_PATH = sys.argv[1]
# data_dir = '../webfp-crossed-fingerprints-data/closed-world/wt-def-keyword/wt-analysis-two-traces/paired-data/wt-def-keyword-2-paired.csv'
data_dir = sys.argv[2]
...
#                 text_2 = lst_text
            ...
            documents_df = pd.DataFrame(messages,columns=['documents_cleaned'])
