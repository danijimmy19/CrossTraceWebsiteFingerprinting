...
python m-4-tfidf-cosine.py /path/to/wt-def-model.h5 /path/to/paired/data
...
# path of the dataset
# data_dir = '/home/danijy/projects/webfp-crossed-fingerprints-data/closed-world/wt-def-keyword/wt-analysis-two-traces-250/paired-data/wt-def-keyword-2-paired.csv'
data_dir = sys.argv[2]
...
print('Average top-3 accuracy is: ', np.mean(acc_3))
print('Average top-4 accuracy is: ', np.mean(acc_4))