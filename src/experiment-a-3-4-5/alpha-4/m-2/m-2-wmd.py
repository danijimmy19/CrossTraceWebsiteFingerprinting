...
python m-2-wmd.py /path/to/wt-def-model.h5 /path/to/paired/data
...
# path to CNN model
# CNN_PATH = '/home/danijy/projects/webfp-crossed-fingerprints/closed-world/models/wt-def-250/wt-def-keyword-100-classes-2000-250-direction-model.h5'
CNN_PATH = sys.argv[1]
# path of the dataset
# data_dir = '/home/danijy/projects/webfp-crossed-fingerprints-data/closed-world/wt-def-keyword/wt-analysis-four-traces-250/paired-data/wt-def-keyword-2-paired.csv'
data_dir = sys.argv[2]
...
# Normalization so all the vectors are of same length
...
#     for i in range(0, 8, 4):
        ...
        temp_acc_1, temp_acc_2 = get_accuracy(pairs_c, pairs_c_dist, t1_actual_label, t2_actual_label, t3_actual_label, t4_actual_label)
