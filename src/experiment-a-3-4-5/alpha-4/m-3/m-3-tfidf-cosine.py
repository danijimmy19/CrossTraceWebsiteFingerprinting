...
python m-3-tfidf-cosine.py /path/to/wt-def-model.h5 /path/to/paired/data
...
#     for i in range(0, 8, 4):
        ...
        temp_acc_1, temp_acc_2, temp_acc_3 = get_accuracy(pairs_c, pairs_c_dist, t1_actual_label, t2_actual_label, t3_actual_label, t4_actual_label)
