...
python m-3-bert-cosine.py /path/to/wt-def-model.h5 /path/to/paired/data
...
def get_similarity(l1, l2):
    ...
    documents_df = pd.DataFrame(documents,columns=['documents_cleaned'])
    document_embeddings = sbert_model.encode(documents_df['documents_cleaned'])
    score = cosine_similarity(document_embeddings)
    sim = score[0][1]
#   print(score) 
    
#     print('similarity between %d and %d is : %.5f'%(l1, l2, sim))
